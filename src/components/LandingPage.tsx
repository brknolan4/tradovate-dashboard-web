...
const CONTAINER = 'max-w-5xl mx-auto w-full px-6 md:px-10';
  ...
  return (
    <div className="min-h-screen w-screen bg-[#070b10] text-white overflow-x-hidden">
      ...
      <div className={`${CONTAINER}`}>
        <nav className="flex items-center justify-between py-6 border-b border-white/[0.05]">
          <Logo />
          <button
      ...
      <section className="relative py-24 md:py-32 text-center">
        ...
        <div className={`${CONTAINER} relative`}>
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-indigo-500/20 bg-indigo-500/[0.08] text-indigo-300 text-[11px] font-black uppercase tracking-[0.24em] mb-8">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
            Built for prop traders
          </div>

          <h1 className="text-5xl md:text-6xl lg:text-[4.25rem] font-black tracking-tight leading-[0.93] mb-7">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-slate-600 text-xs tracking-wide">Free to use · Sign in with Google · No credit card</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 border-t border-white/[0.05]">
        <div className={`${CONTAINER}`}>
          <div className="text-center mb-16">
            <p className="text-indigo-400 text-[11px] font-black uppercase tracking-[0.3em] mb-4">What you get</p>
            <h2 className="text-3xl md:text-4xl font-black tracking-tight mb-5">
              Everything your eval requires
            </h2>
            <p className="text-slate-400 text-lg max-w-lg mx-auto leading-relaxed">
              One dashboard. Every metric your prop firm is watching — all in one place.
            </p>
          </div>
      ...
      <section className="py-24 md:py-32 border-t border-white/[0.05]">
        <div className={`${CONTAINER}`}>
          ...
          {/* Calendar mockup — full width, centered */}
          <BrowserFrame>
            <CalendarMockup />
          </BrowserFrame>
        </div>
      ...
      {/* ── Bottom CTA ──────────────────────────────── */}
      <section className="py-24 md:py-32 border-t border-white/[0.05] text-center">
        <div className={`${CONTAINER}`}>
          <p className="text-indigo-400 text-[11px] font-black uppercase tracking-[0.3em] mb-6">Ready to track your eval?</p>
          <h2 className="text-4xl md:text-5xl font-black tracking-tight leading-[0.93] mb-6">
            Your next funded<br />account starts here.
          </h2>
          <p className="text-slate-400 text-lg leading-relaxed mb-12 max-w-md mx-auto">
...
function BrowserFrame({ children }: { children: React.ReactNode }) {
  return (
    <div className="rounded-[22px] border border-white/[0.08] overflow-hidden shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_40px_100px_rgba(0,0,0,0.65)]">
      <div className="flex items-center gap-1.5 px-4 py-3.5 bg-[#0a0f1a] border-b border-white/[0.06]">
        <div className="w-3 h-3 rounded-full bg-[#ff5f57]/80" />
        <div className="w-3 h-3 rounded-full bg-[#febc2e]/80" />
        <div className="w-3 h-3 rounded-full bg-[#28c840]/80" />
        <div className="flex-1 flex justify-center">
          <div className="w-44 h-5 rounded-md bg-white/[0.04] border border-white/[0.05] flex items-center justify-center">
...
function DashboardMockup() {
  ...
  return (
    <div className="bg-[#0c1220] flex" style={{ minHeight: 460 }}>
      {/* Sidebar */}
      <div className="w-16 bg-[#080c15] border-r border-white/[0.04] flex flex-col items-center py-5 gap-3 shrink-0">
        <div className="w-9 h-9 bg-gradient-to-br from-emerald-400 to-cyan-500 rounded-xl flex items-center justify-center mb-3 shadow-lg shadow-emerald-500/20">
          <svg className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <rect x="3" y="3" width="7" height="7" /><rect x="14" y="3" width="7" height="7" />
            <rect x="14" y="14" width="7" height="7" /><rect x="3" y="14" width="7" height="7" />
          </svg>
        ...
        {(['M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z', 'M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M9 3v18m0 0h10a2 2 0 0 0 2-2V9M9 21H5a2 2 0 0 1-2-2V9m0 0h18', 'M3 4h18M3 8h18M3 12h12'] as string[]).map((d, i) => (
          <div key={i} className={`w-9 h-9 rounded-xl flex items-center justify-center transition-all ${i === 0 ? 'bg-indigo-500/20 border border-indigo-500/25' : 'opacity-25 hover:opacity-50'}`}>
      ...
      <div className="flex-1 p-6 flex flex-col gap-4 min-w-0">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-500 text-[10px] mt-0.5">Account · Apex 50k Evaluation</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-3">
          {[
            { label: 'Account Balance', val: '$52,840', sub: '+$2,840 gain', color: 'text-white', pct: 56, barC: '#6366f1' },
            { label: 'Net P&L',         val: '+$2,840',  sub: '↑ 5.7% return',   color: 'text-emerald-400', pct: 28, barC: '#22c55e' },
            { label: "Today's P&L",     val: '+$420',   sub: 'Best day $820',  color: 'text-emerald-400', pct: 42, barC: '#22c55e' },
            { label: 'Win Rate',        val: '67%',     sub: '18W · 9L',       color: 'text-cyan-400',    pct: 67, barC: '#06b6d4' },
          ].map(c => (
            <div key={c.label} className="rounded-2xl border border-white/[0.07] bg-white/[0.025] p-3">
        ...
        <div className="grid grid-cols-4 gap-3">
          {[
            ...
            return (
              <div key={d.label} className="rounded-2xl border border-white/[0.07] bg-white/[0.025] p-3 flex items-center gap-3">
                <div className="relative shrink-0">
                  <svg width="40" height="40" viewBox="0 0 40 40">
                    ...
                    <circle cx="20" cy="20" r={r} fill="none" stroke={c.ring} strokeWidth="3.5"
                      ...
                      strokeLinecap="round" transform="rotate(-90 20 20)" opacity="0.85" />
                  </svg>
                ...
                <div className="min-w-0">
                  <div className="text-[7.5px] text-slate-500 uppercase tracking-wider font-black leading-tight mb-0.5">{d.label}</div>
        ...
        {/* Equity chart */}
        <div className="rounded-2xl border border-white/[0.07] bg-white/[0.02] p-4 flex-1 min-h-0">
...
function CalendarMockup() {
  type Day = { pnl: number; trades: number } | null;
  const weeks: Day[][] = [
  ...
  const col = (pnl: number) => {
    if (pnl >= 600) return { bg: 'rgba(34,197,94,0.65)',  txt: '#d1fae5' };
    if (pnl >= 300) return { bg: 'rgba(34,197,94,0.40)',  txt: '#a7f3d0' };
    if (pnl >    0) return { bg: 'rgba(34,197,94,0.18)',  txt: '#6ee7b7' };
    if (pnl > -200) return { bg: 'rgba(239,68,68,0.22)',  txt: '#fca5a5' };
    return               { bg: 'rgba(239,68,68,0.50)',  txt: '#fecaca' };
  };

  const allDays = weeks.flat().filter(Boolean) as { pnl: number; trades: number }[];
  ...
  return (
    <div className="bg-[#0c1220] p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <div className="text-[9px] text-slate-500 uppercase tracking-[0.3em] font-black mb-1">Trade Calendar</div>
          <div className="text-white font-black text-base">April 2026</div>
        </div>
        <div className="flex gap-3">
          {[
            { label: 'Net P&L',   val: `+$${(totalPnl / 1000).toFixed(1)}k`, color: '#34d399' },
            { label: 'Win Days',  val: `${winDays} / ${allDays.length}`,       color: '#22d3ee' },
            { label: 'Best Day',  val: '+$820',                                color: '#a78bfa' },
          ].map(s => (
            <div key={s.label} className="rounded-xl border border-white/[0.07] bg-white/[0.025] px-4 py-2.5 text-center">
      ...
      <div className="grid grid-cols-5 gap-2.5 mb-2">
        {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'].map(d => (
          <div key={d} className="text-center text-[8px] text-slate-600 font-black uppercase tracking-widest">{d}</div>
        ))}
      </div>
      ...
      <div className="space-y-2.5">
        {weeks.map((week, wi) => (
          <div key={wi} className="grid grid-cols-5 gap-2.5">
            {week.map((day, di) => {
              if (!day) return (
                <div key={di} className="rounded-2xl h-20 border border-white/[0.03] bg-white/[0.01]" />
              );
              const c = col(day.pnl);
              return (
                <div
                  key={di}
                  className="rounded-2xl h-20 border border-white/[0.06] p-3 flex flex-col justify-between cursor-pointer hover:brightness-110 transition-all"
                  style={{ background: c.bg }}
                >
                  <span className="text-[10px] font-black" style={{ color: c.txt }}>
                    {day.pnl >= 0 ? '+' : ''}
                    {Math.abs(day.pnl) >= 1000
                      ? `$${(day.pnl / 1000).toFixed(1)}k`
                      : `$${Math.abs(day.pnl)}`}
                  </span>
                  <span className="text-[8px]" style={{ color: `${c.txt}88` }}>{day.trades} trades</span>
                </div>
              );
            })}
          </div>
      ...
      <div className="flex items-center justify-center gap-2.5 mt-6">
        ...
        {[
          'rgba(239,68,68,0.50)', 'rgba(239,68,68,0.22)',
          'rgba(34,197,94,0.18)', 'rgba(34,197,94,0.40)', 'rgba(34,197,94,0.65)',
        ].map(bg => (
          <div key={bg} className="w-6 h-3 rounded" style={{ background: bg }} />
        ))}
